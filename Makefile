...
test: $(TEST_PROGRAM)
	@echo "=== Running number conversion tests ==="
	./$(TEST_PROGRAM)
	@echo ""

run: $(PROGRAM)
	@echo "=== Running number conversion demonstration ==="
	./$(PROGRAM)
	@echo ""
...
help:
	...
	@echo "  run         - запустить демонстрационную программу"
	@echo "  debug       - запустить с valgrind"
	@echo "  debug-test  - запустить тесты с valgrind"
	@echo "  fast        - быстрая компиляция без sanitizers"
	@echo "  clean       - удалить скомпилированные файлы"
	@echo "  format      - отформатировать код"
	@echo "  help        - показать эту справку"

.PHONY: all test run debug debug-test fast clean format help